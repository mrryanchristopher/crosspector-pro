    ...
    <div className="min-h-screen pb-20 bg-[#050505]">
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="glass-panel p-6 rounded-2xl border border-white/5">
              ...
              <div className="grid grid-cols-2 gap-2 mt-4 pt-4 border-t border-white/5">
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="py-2 bg-white/5 hover:bg-yellow-500/10 text-gray-500 hover:text-yellow-500 font-bold rounded-lg text-[9px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all border border-transparent hover:border-yellow-500/30"
                >
                  <i className="fas fa-lock text-[8px]"></i> PDF Export
                </a>
                <a 
                  href="https://play.google.com/store/apps/details?id=com.crosspectorprov2.app&pcampaignid=web_share"
                  target="_blank"
                  ...
                  className="py-2 bg-white/5 hover:bg-yellow-500/10 text-gray-500 hover:text-yellow-500 font-bold rounded-lg text-[9px] uppercase tracking-widest flex items-center justify-center gap-2 transition-all border border-transparent hover:border-yellow-500/30"
                >
                  <i className="fas fa-lock text-[8px]"></i> DOCX Export
                </a>
              </div>
            </div>
            ...
            <div className="glass-panel p-6 rounded-2xl border border-yellow-500/20 bg-yellow-500/5 relative overflow-hidden group">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block w-full py-3 bg-yellow-500 hover:bg-yellow-600 text-black font-black rounded-xl text-[10px] uppercase tracking-widest text-center transition-all shadow-lg shadow-yellow-500/20 active:scale-[0.98]"
              >
          ...
          <div className="lg:col-span-8">
            <div className="flex flex-wrap gap-2 mb-6 p-1 bg-white/5 rounded-2xl w-fit">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-2.5 rounded-xl text-xs font-black transition-all uppercase tracking-widest flex items-center space-x-2 text-gray-600 bg-white/5 border border-white/5 grayscale"
              >
                <i className="fas fa-lock text-[10px]"></i>
                <span>Macro Assets</span>
                <span className="ml-2 text-[8px] bg-yellow-500 text-black px-1 rounded">PRO</span>
              </a>
            </div>
            ...
            {filteredOpps.length === 0 ? (
              <div className="glass-panel rounded-3xl p-20 flex flex-col items-center justify-center text-center space-y-6 border-dashed border-2 border-white/5">
                ...
                <div>
                   ...
                   <p className="text-gray-500 text-sm max-w-sm mx-auto mt-2 italic">Run a scan to find real-time spreads. Advanced markets like Crypto and Bullion available in Crosspector Pro.</p>
                </div>
              </div>
            ) : (
      ...
      <footer className="mt-20 border-t border-white/10 py-12 text-center space-y-4">
        ...
        <p className="text-gray-700 text-[9px] max-w-2xl mx-auto mt-4 px-4 leading-relaxed">
          ...
          >
            Crosspector Pro Available Now
          </a>
          <br />
          The Pro version on the Google Play Store offers extended capabilities including Crypto, Stocks, and Precious Metals Arbitrage with 50+ results per session. One-time payment, no sign-up, and subscriptionless.
        </p>
      </footer>
    </div>
  );
